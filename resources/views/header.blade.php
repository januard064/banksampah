...
<li class="nav-item">
  ...
  <li class="nav-item dropdown">
    ...
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Hai, <?php echo $akun->Nama(); ?> </a>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="#">Poin = <?php echo $akun->Poin(); ?> </a>
