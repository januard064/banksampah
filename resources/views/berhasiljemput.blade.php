...
<div class="card" style="width:500px; height:200px; margin-left:30%; background-color:#F3F6F3; margin-top:5%; " >
  <div class="card-body">
    ...
    <h6 style="margin-left:12%; margin-top:30px; font-size:20px; font-color:#1D8927;">Silahkan Menunggu Konfirmasi dari Admin</h6>
    
    <button type="button" class="btn btn-success" style="margin-left:42%; margin-top:10px;" ><a style="color:black;" href="jemput" class="card-link">OK</a></button>
