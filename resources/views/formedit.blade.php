...
<h3 style="margin-bottom:40px;color:#268986 ;font-weight:bold; margin-left: 46%;">EDIT AKUN</h3>
...
<div class="form-group row">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="nama_lengkap" style="width:500px;" value="<?php echo $akun->Nama(); ?>" >
    </div>
  </div>
  ...
  <div class="form-group row" style="display:none;">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="poin" style="width:500px;" value="<?php echo $akun->Poin(); ?>" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="no_telp" style="width:500px;" value="<?php echo $akun->Telepon(); ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="pekerjaan" style="width:500px;" value="<?php echo $akun->Pekerjaan(); ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="no_identitas" style="width:500px;" value="<?php echo $akun->Id(); ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
    <input class="" type="text" name="alamat" style="width:500px;" value="<?php echo $akun->Alamat(); ?>" >
    </div>
  </div>
